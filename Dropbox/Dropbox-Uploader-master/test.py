...
def sap2():
        ...
        os.system("bash dropbox_uploader.sh delete "+name+"")
        print("Operation Successfully Completed")

def sap3():
        print("Create Directory : ")
        name = raw_input('Enter name of new Directory :')
        os.system("bash dropbox_uploader.sh mkdir "+name+"")
        print("Operation Successfully Completed")

def sap5():
        print("Directories are :  : ")
        
        os.system("bash dropbox_uploader.sh list")
        print("Operation Successfully Completed")
...
def sap6():
        ...
        os.system("bash dropbox_uploader.sh upload /home/tejaswini/a.txt /")
        print("Operation Successfully Completed")
...
def sap7():
        ...
        os.system("bash dropbox_uploader.sh download /a.txt /home/dbsl/4316")

        print("Operation Successfully Completed")
		os.system("cat /home/tejaswini/a.txt")        
